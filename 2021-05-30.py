...
p3 >> play("sss(sss )", sample=(9, 8), amp=0.8)
...
b2 >> dirt(Pvar([0, -1, -2, -4]), dur=PDur(3, 8), amp=0.2)
...
v1 >> viola(
    Pvar([5, 2, 0, 0]).arp([0, 2]), dur=[1, 1 / 2, 1 / 2, 3 / 4, 1 / 2, 3 / 4], amp=0.4
).every(12, "stutter")
...
aa.stop()
bb >> pasha(var.c, delay=1, dur=2, echo=0.2)
bb.stop()


var.d = var([0, 1, [3, -2], [3, var([5, 3], 1)]], [4, 4, 2, 2])
pp >> pluck(var.d + (0, 2), dur=2, delay=0.5)
aa >> blip(var.d + [4, 2, 4, 5], dur=1 / 2)
bb >> dbass(var.d + [0, 7], dur=PDur(2, 8))
kk >> orient(
    var.d + [[0, [2, 3]], 2, [3, [4, 6]], 4, [5, [6, 7]]], dur=PDur(4, 8), amp=1.2
).every(4, "reverse")
